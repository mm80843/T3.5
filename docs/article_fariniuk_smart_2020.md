 ...
 * administração pública, analog, application program, [big datum](keyword_big_datum), brasil, brasília, [brazil](keyword_brazil), ciberespaço, cidade, [city](keyword_city), city hall, collective intelligence, colomer llinàs j, consolidation, coronavírus, [covid-19](keyword_covid-19), curitiba, cyber security, [datum](keyword_datum), demand, [digital](keyword_digital), dilemas da recentralização, distritofederal, [education](keyword_education), educational, egregiously, elaborate, elaborate by the author, [embody](keyword_embody), emergency response, [epidemiology](keyword_epidemiology), figueiredo, filho, fragmentation, gdp, gdp per capita, governance, governar as metrópole, [health](keyword_health), history, ibge, [innovation](keyword_innovation), instituto brasileiro de geografia e estatística, [integration](keyword_integration), le città invisibili, legend, letouzé, llacuna m, malasya, metropolis, ministry of health, ministério da saúde, municipality, [new jersey](keyword_new_jersey), nj, northeastern, northern, pandemia, [pandemic](keyword_pandemic), pandemic curve, pandemic situation, paraná, pedagogical, penang, [physical](keyword_physical), platform, pontifícia universidade católica do paraná, pr, pr brazil, [protocol](keyword_protocol), [public administration](keyword_public_administration), quantitative, response, rio de janeiro, rj, rolnik, saúde, [smart city](keyword_smart_city), smart city and the pandemic, smart sustainable city of the future, smart utopia, smartphone, [solution](keyword_solution), somekh, southern, sp, sterly, [surveillance](keyword_surveillance), são paulo, [technology](keyword_technology), telephone exchange, the author, tradingview, [united kingdom](keyword_united_kingdom), university of oxford, urban management, α1σ, α2σ, ἀintelligence, ἀtechnology


## Concepts

 ![](plotly/article_fariniuk_smart_2020.svg)
