 ...
 * Cluster_10, architectural view, city and memory project, datum collection, datum processing, disease exposure, geographical datum, hypernym, information, [mapping](keyword_mapping), material and information ow mapping, [model](keyword_model), [ontology](keyword_ontology), [plan](keyword_plan), qgis, reject or select, [survey](keyword_survey), visualization


## Concepts

 ![](imgs/keyword_mapping.jpg)
