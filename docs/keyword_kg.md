 ...
 * Cluster_13, biomedicine, campbell lendrum dh, character kg, [covid-19](keyword_covid-19), [datum](keyword_datum), dbpedia, dean sg, entity alignment, health kg, huawei, huawei cloud, [kg](keyword_kg), knowledge graph, [openkg covid19](keyword_openkg_covid19), precision, rdf triple, [sar cov 2](keyword_sar_cov_2), sar cov 2 phylogeny, schema, schemata, sound schema, source, van den wymelenberg kg, yago



## Mapping

<img src="plotly/keyword_kg.svg">
