 ...
 * abouelmehdi, agriculture, allam z, alomair, [australia](keyword_australia), belgium, beni hessane, bhadani, [big datum](keyword_big_datum), big datum analytic, [blockchain](keyword_blockchain), chen x, [china](keyword_china), [city](keyword_city), concept, conflict, crime, [croatia](keyword_croatia), crutzen, curtin university, datapriv, [datum](keyword_datum), [economic](keyword_economic), elmaghraby, governance, [government](keyword_government), guerrini, hacker, huawei, ict, [india](keyword_india), institution, [internet of thing](keyword_internet_of_thing), [iot](keyword_iot), j netw, [japan](keyword_japan), khaloufi, kummitha, li z, [london](keyword_london), losavio, ma s, martínez ballesté, mauritius, mckinsey and company, microsoft, milenkovic, mob, netw, network, [new york](keyword_new_york), [new york city](keyword_new_york_city), newman p, opatija, [organisation](keyword_organisation), pamplona, [perspective](keyword_perspective), perth, [plan](keyword_plan), [policy](keyword_policy), poovendran, port louis, ppp, [privacy](keyword_privacy), privacy concern, private company, private partner, private sector, propaganda, public private partnership, public sector, regul, [robot](keyword_robot), [safe city](keyword_safe_city), [safety](keyword_safety), [security](keyword_security), [sensor](keyword_sensor), singapore, [smart](keyword_smart), [smart city](keyword_smart_city), smart device, smartness, [social](keyword_social), sustain, [sustainability](keyword_sustainability), [switzerland](keyword_switzerland), [technology](keyword_technology), top, transparency, [united kingdom](keyword_united_kingdom), [urban](keyword_urban), [usa](keyword_usa), [violence](keyword_violence), vulnerably, [washington dc](keyword_washington_dc), yang y, yigitcanlar, yinchuan, [چہ](keyword_چہ), ḍperp


## Concepts

 ![](imgs/article_allam_emergence_2019.jpg)
