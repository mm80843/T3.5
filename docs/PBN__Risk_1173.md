# RISK: __Harmful effects of UV-C light on humans if not properly shielded__ (PBN__Risk_1173)
...
* [Ensure that upper-room UVGI systems are properly designed with louvers or shields to prevent UV-C light exposure to room occupants](PBN__RiskMitigation_1625)
