# RISK: __High variability in input parameters__ (PBN__Risk_1052)
...
* [Incorporate uncertainty and variability in input parameters using a Monte Carlo approach in the estimation model](PBN__RiskMitigation_1485)
