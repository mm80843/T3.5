 ...
 * [age group](keyword_age_group), appliance, appolloni, behaviour, bias, [build environment](keyword_build_environment), close, comfort, [confinement](keyword_confinement), consumption, cool system, [coronavirus](keyword_coronavirus), [covid 19 pandemic](keyword_covid_19_pandemic), [covid-19](keyword_covid-19), d alessandro, datum analysis, dedication, device, dichotomous, discourse, dishwasher, dwell, [education](keyword_education), [energy](keyword_energy), [energy consumption](keyword_energy_consumption), energy expenditure, equipment, españa, estadística, [europe](keyword_europe), eurostat, fara, frequency, gola, habit, habitability, hamadani, healing, [health](keyword_health), heating system, hoffman, [home](keyword_home), home space, hot water, [household](keyword_household), household appliance, [housing](keyword_housing), image, [indoor air quality](keyword_indoor_air_quality), ine, instituto nacional de estadística, [internet](keyword_internet), kraków, leisure, [lockdown](keyword_lockdown), m n m, m á, madrid, maximum time dedication, [medical](keyword_medical), meeting place, minimum time dedication, nivel y condiciones de vida, online form, [pandemic](keyword_pandemic), [participant](keyword_participant), participation, period, photo, photograph, photovoice, [poland](keyword_poland), prtesti, [psychological](keyword_psychological), [public health](keyword_public_health), [qualitative](keyword_qualitative), quantitative, quantitative questionnaire, questionnaire, [research](keyword_research), s j, software, song, [space](keyword_space), [spain](keyword_spain), spanish, sport, spring, stata, [survey](keyword_survey), surveymonkey, [system](keyword_system), t c v, t n m, tag, teleworke, [thermal comfort](keyword_thermal_comfort), valid, virtue, washing machine


## Concepts

 ![](imgs/article_cuerdo-vilches_mixed_2020.jpg)
