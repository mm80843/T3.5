 ...
 * 1 n engl j med, 24 hour, 8 hour, 95 credible interval, I bar, SARS-CoV-2, [aerosol](keyword_aerosol), aerosolize, [air](keyword_air), allergy, amplitude, asymptomatic, atlanta, b sc, bushmaker, can bethesda, can brandi, cardboard, cell host, center for disease control and prevention, chan cc, [china](keyword_china), [copper](keyword_copper), [coronavirus](keyword_coronavirus), department of defense, department of health and human service, emergency room, end point titration, estimate, estimate difference, experimental, ga james, half life, halflife, hamilton, [hospital](keyword_hospital), huang b, huang lm, huang m, infectious, [infectious disease](keyword_infectious_disease), infectious dose, line, liter, logarithmic scale, los angeles los angeles, low respiratory tract, mean, microbe, milliliter, mt amandine gamble, ng l, nj myndi g holbrook, [pandemic](keyword_pandemic), peng y, plastic, posterior median, [public health](keyword_public_health), quantify, regression plot, relative humidity, replicate, replicate datum, respiratory tract, ruan f, s1, s5, [sar cov 1](keyword_sar_cov_1), sar cov 1 tor2, [sar cov 2](keyword_sar_cov_2), sarscov 1, science foundation, severe acute respiratory syndrome coronavirus 2, specimen, [stainless steel](keyword_stainless_steel), standard error, strain, [surface](keyword_surface), tcid50, [temperature](keyword_temperature), the n e w e ng l a n d j o u r na l of m e, time, tin, tissue culture, titer, transmit, trenton bushmaker, university of california, university princeton, [upper](keyword_upper), upper respiratory, uppsala university, viable virus, [viral](keyword_viral), [virus](keyword_virus), virus titer, waveform, wu a, [wuhan](keyword_wuhan), zou l


## Concepts

 ![](plotly/article_van_doremalen_aerosol_2020.svg)
