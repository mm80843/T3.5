...
* We have 174 articles in database.
* We have identified 251169 relationships between terms.
* We have identified 16 topics of interest.

# Clusters

* [blockchain-technology](cluster_13)
* [air-ventilation](cluster_8)
* [health-city](cluster_0)
* [construction-project](cluster_3)
* [air-formaldehyde](cluster_4)
* [construction-resilience](cluster_2)
* [wastewater-sars](cluster_12)
* [fake-medium](cluster_10)
* [surface-coating](cluster_11)
* [building-space](cluster_7)
* [resilience-infrastructure](cluster_9)
* [building-guidance](cluster_6)
* [om-ai](cluster_1)
* [surveying-drone](cluster_14)
* [ontology-datum](cluster_15)
* [space-flexible](cluster_5)


# Terms
* [access](keyword_access), [accurate](keyword_accurate), [acs](keyword_acs), [adapt](keyword_adapt), [adaptive](keyword_adaptive), [aerosol](keyword_aerosol), [ai](keyword_ai), [air](keyword_air), [airborne](keyword_airborne), [airow](keyword_airow), [alteration](keyword_alteration), [analysis](keyword_analysis), [analytic](keyword_analytic), [andre](keyword_andre), [animal](keyword_animal), [antimicrobial](keyword_antimicrobial), [antiviral](keyword_antiviral), [anxiety](keyword_anxiety), [application](keyword_application), [assay](keyword_assay), [assessment](keyword_assessment), [asset](keyword_asset), [base](keyword_base), [bed](keyword_bed), [behaviour](keyword_behaviour), [big](keyword_big), [biomarker](keyword_biomarker), [biomedical](keyword_biomedical), [blockchain](keyword_blockchain), [botanical](keyword_botanical), [bre](keyword_bre), [breeam](keyword_breeam), [build](keyword_build), [building](keyword_building), [bulletin](keyword_bulletin), [business](keyword_business), [campus](keyword_campus), [capacity](keyword_capacity), [cell](keyword_cell), [chamber](keyword_chamber), [change](keyword_change), [china](keyword_china), [city](keyword_city), [click](keyword_click), [climate](keyword_climate), [clinical](keyword_clinical), [coating](keyword_coating), [code](keyword_code), [community](keyword_community), [company](keyword_company), [concentration](keyword_concentration), [construction](keyword_construction), [consulting](keyword_consulting), [contact](keyword_contact), [contain](keyword_contain), [contractor](keyword_contractor), [control](keyword_control), [coron](keyword_coron), [corona](keyword_corona), [coronavirus](keyword_coronavirus), [country](keyword_country), [crisis](keyword_crisis), [data](keyword_data), [datum](keyword_datum), [delivery](keyword_delivery), [design](keyword_design), [detection](keyword_detection), [device](keyword_device), [digital](keyword_digital), [disease](keyword_disease), [domain](keyword_domain), [drone](keyword_drone), [drones](keyword_drones), [droplet](keyword_droplet), [drug](keyword_drug), [economic](keyword_economic), [employee](keyword_employee), [energy](keyword_energy), [enforce](keyword_enforce), [engineer](keyword_engineer), [engineering](keyword_engineering), [environment](keyword_environment), [epidemiological](keyword_epidemiological), [epidemiology](keyword_epidemiology), [facebook](keyword_facebook), [fake](keyword_fake), [fever](keyword_fever), [filter](keyword_filter), [flexible](keyword_flexible), [formaldehyde](keyword_formaldehyde), [gene](keyword_gene), [gerba](keyword_gerba), [glass](keyword_glass), [green](keyword_green), [guest](keyword_guest), [harvard](keyword_harvard), [health](keyword_health), [healthcare](keyword_healthcare), [home](keyword_home), [hospital](keyword_hospital), [human](keyword_human), [ieq](keyword_ieq), [impact](keyword_impact), [indoor](keyword_indoor), [industry](keyword_industry), [infection](keyword_infection), [infectious](keyword_infectious), [information](keyword_information), [infrastructure](keyword_infrastructure), [internet](keyword_internet), [interoperability](keyword_interoperability), [iot](keyword_iot), [kg](keyword_kg), [knowledge](keyword_knowledge), [level](keyword_level), [lm](keyword_lm), [lter](keyword_lter), [management](keyword_management), [mapping](keyword_mapping), [may](keyword_may), [measure](keyword_measure), [medical](keyword_medical), [medium](keyword_medium), [mental](keyword_mental), [method](keyword_method), [microbiome](keyword_microbiome), [misinformation](keyword_misinformation), [ml](keyword_ml), [model](keyword_model), [modular](keyword_modular), [network](keyword_network), [news](keyword_news), [occupancy](keyword_occupancy), [occupant](keyword_occupant), [oecd](keyword_oecd), [ofce](keyword_ofce), [office](keyword_office), [officer](keyword_officer), [online](keyword_online), [ontological](keyword_ontological), [ontology](keyword_ontology), [oor](keyword_oor), [overload](keyword_overload), [owner](keyword_owner), [oxide](keyword_oxide), [pande](keyword_pande), [pandemic](keyword_pandemic), [participant](keyword_participant), [patient](keyword_patient), [pcr](keyword_pcr), [people](keyword_people), [permission](keyword_permission), [plant](keyword_plant), [policy](keyword_policy), [pollution](keyword_pollution), [polymer](keyword_polymer), [population](keyword_population), [primer](keyword_primer), [prohibit](keyword_prohibit), [project](keyword_project), [pu](keyword_pu), [public](keyword_public), [qpcr](keyword_qpcr), [quarantine](keyword_quarantine), [rate](keyword_rate), [remote](keyword_remote), [removal](keyword_removal), [representation](keyword_representation), [reproduce](keyword_reproduce), [reproduction](keyword_reproduction), [requirements](keyword_requirements), [research](keyword_research), [resilience](keyword_resilience), [respiratory](keyword_respiratory), [respondent](keyword_respondent), [rh](keyword_rh), [risk](keyword_risk), [rna](keyword_rna), [robot](keyword_robot), [robotics](keyword_robotics), [room](keyword_room), [rst](keyword_rst), [safety](keyword_safety), [sample](keyword_sample), [sars](keyword_sars), [sarvari](keyword_sarvari), [say](keyword_say), [scmp](keyword_scmp), [sector](keyword_sector), [semantic](keyword_semantic), [sewage](keyword_sewage), [share](keyword_share), [shenzhen](keyword_shenzhen), [shock](keyword_shock), [simulation](keyword_simulation), [site](keyword_site), [smart](keyword_smart), [social](keyword_social), [sociale](keyword_sociale), [solution](keyword_solution), [space](keyword_space), [stainless](keyword_stainless), [steel](keyword_steel), [study](keyword_study), [surface](keyword_surface), [surveillance](keyword_surveillance), [surveying](keyword_surveying), [system](keyword_system), [task](keyword_task), [tech](keyword_tech), [technology](keyword_technology), [telehealth](keyword_telehealth), [test](keyword_test), [titer](keyword_titer), [transmission](keyword_transmission), [type](keyword_type), [uav](keyword_uav), [urban](keyword_urban), [user](keyword_user), [uv](keyword_uv), [valley](keyword_valley), [ventilation](keyword_ventilation), [views](keyword_views), [viral](keyword_viral), [virtual](keyword_virtual), [virus](keyword_virus), [visualization](keyword_visualization), [vocs](keyword_vocs), [vr](keyword_vr), [wastewater](keyword_wastewater), [water](keyword_water), [well](keyword_well), [work](keyword_work), [worker](keyword_worker), [workforce](keyword_workforce), [world](keyword_world)

# Articles

* [An Overview of Ontologies and Tool Support for
COVID-19 Analytics](article_ahmad_overview_2021)
...
Safety Perspective](article_aloulou_design_2022)
* [A Review on Building Design as a Biomedical
System for Preventing COVID-19 Pandemic](article_amran_review_2022)
* [Adaptive Design of the Built Environment to
Mitigate the Transmission Risk of COVID-19](article_ara_dilshad_shangi_adaptive_2020)
...
of COVID-19](article_ayub_graphene-based_2021)
...
and Infectious Diseases Representation](article_bayoudhi_overview_2021)
...
SARS-CoV-2](article_behzadinasab_surface_2020)
...
cities](article_bolivar_learning_2022)
...
Shift](article_bratic_should_2021)
* [Understanding the role of urban design in disease
spreading](article_brizuela_understanding_2019)
* [COVID-19 media fatigue: predictors of decreasing
interest and avoidance of COVID-19–related news](article_buneviciene_covid-19_2021)
...
COVID 19 Pandemic Outbreak](article_cheshmehzangi_10_2020)
* [Revisiting the built environment: 10 potential development
changes and paradigm shifts due to COVID-19](article_cheshmehzangi_revisiting_2021)
...
Buildings](article_cole_navigating_2020)
...
Industry](article_dan-jumbo_covid-19_2021)
* [Epidemics, Planning and the City: A Special
Issue of Planning Perspectives](article_davis_epidemics_2022)
...
analysis of German county level data](article_ehlert_socio-economic_2021)
* [Amplifying the role of knowledge translation platforms in
the COVID-19 pandemic response](article_el-jardali_amplifying_2020)
...
Project Delivery Model](article_g_overcoming_2020)
...
our capacity to respond to climate change](article_gemenne_what_2020)
* [An Intelligent IEQ Monitoring and Feedback
System: Development and Applications](article_geng_intelligent_2021)
...
COVID-19 pandemic in The Netherlands](article_hou_study_2021)
...
KI-pass QR Code Checking](article_huy-tran_design_2022)
...
effective against Human Coronavirus 229E](article_ikner_continuously_2020)
* [COVID-19 Prevention and Control Measures in
Workplace Settings: A Rapid Review and
Meta-Analysis](article_ingram_covid-19_2021)
...
European Green Deal](article_klein_borders_2021)
...
cyberchondria during the COVID-19 pandemic?](article_laato_what_2020)
* [Designing a Multi-Agent Occupant Simulation
System to Support Facility Planning and Analysis
for COVID-19](article_lee_designing_2021)
...
AnyLogic](article_li_building_2016)
...
COVID-19 on tourists’ behavioral patterns](article_li_seeing_2020)
...
Fight COVID-19?](article_mehta_pandemic_2021)
* [Role of Information Technology in Covid-19
Prevention](article_mehtab_alam_role_2021)
...
* [The Handbook of Salutogenesis](article_mittelmark_handbook_2022)
...
new normal](article_naor_impact_2022)
...
China](article_ning_impacts_2020)
* [COVID-19 misinformation: Accuracy of articles about
coronavirus prevention mostly shared on social media](article_obiala_covid-19_2021)
* [Global value chains: Efficiency and risks in the context
of COVID-19](article_oecd_global_2021)
* [What has been the impact of the COVID-19 pandemic on
immigrants? An update on recent evidence](article_oecd_what_2022)
...
Impacted Circular Economic of Covid-19 Pandemic](article_paikan_effects_2021)
* [Impacts of COVID-19 on Health and Safety of
Workforce in Construction Industry](article_pamidimukkala_impacts_2021)
* [Technology intervention for preventing COVID-19
outbreak](article_pandey_technology_2021)
...
With Chronic Exposure to Lower Air Quality](article_pansini_covid-19_2021)
...
interaction](article_quantin_covid-19_2022)
...
Surveillance and Prevention](article_raza_mobile_2021)
* [Urban Green Infrastructure and Green Open
Spaces: An Issue of Social Fairness in Times of
COVID-19 Crisis](article_reinwald_urban_2021)
...
General Population—A Systematic Review](article_rodriguez-fernandez_psychological_2021)
...
systems for enhanced public health](article_saini_comprehensive_2020)
...
study](article_saman_recently_2021)
* [Mental health economics: A prospective study on
psychological flourishing and associations with healthcare
costs and sickness benefit transfers in Denmark](article_santini_mental_2021)
...
Settlement Characteristics and Population](article_sigler_socio-spatial_2020)
* [COVID-ABS: An agent-based model of COVID-19
epidemic to simulate health and economic effects of social
distancing interventions](article_silva_covid-abs_2020)
...
identify priorities for planning urban settlements](article_syal_learning_2021)
* [Challenges of data sharing in European Covid-19
projects: A learning opportunity for advancing pandemic
preparedness and response](article_tacconelli_challenges_2022)
* [COVID-19 and regional solutions for mitigating the risk
of SME finance in selected ASEAN member states](article_taghizadeh-hesary_covid-19_2022)
* [Real-world data show that filters clean COVID-causing
virus from air](article_thompson_real-world_2021)
* [COVID19: Small and medium enterprises challenges and
responses with creativity, innovation, and
entrepreneurship](article_thukral_covid19_2021)
...
Lessons learnt from the Covid-19 pandemic](article_tomalska_preparing_2022)
* [Social distancing enhanced automated optimal design of
physical spaces in the wake of the COVID-19 pandemic](article_ugail_social_2021)
...
Knowledge Graphs: Development and Applications](article_wang_construction_2022)
* [Disinfection technology of hospital wastes and wastewater:
Suggestions for disinfection strategy during coronavirus
Disease 2019 (COVID-19) pandemic in China](article_wang_disinfection_2020)
* [The Smart City and Covid‐19](article_webb_smart_2020)
* [How COVID-19 Could Accelerate the Adoption of
New Retail Technologies and Enhance the
(E-)Servicescape](article_willems_how_2021)
* [Current knowledge of COVID-19: Advances, challenges
and future perspectives](article_wu_current_2021)
* [Open-source analytics tools for studying the COVID-19
coronavirus outbreak](article_wu_open-source_2020)
* [SARS-CoV-2 Titers in Wastewater Are Higher
than Expected from Clinically Confirmed Cases](article_wu_sars-cov-2_2020)
* [Green Buildings: A Post COVID-19 Analysis of
Preventive Measures of Spreading the Virus](article_yakubu_aminu_dodo_green_2020)
...
Systemized Review](article_zhao_supporting_2022)
