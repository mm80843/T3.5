...
* Terms
  * and 213 main terms from the clusters.
  * and 49 other relevant words or expressions.
* Blueprints
  * We are trying 25 blueprints.
...
* [Animal vectors control](bp_22)
* [Tracking and enforcing use of Personal Protective Equipment](bp_23)
...
* [ontology-datum](cluster_3)
* [housing-space](cluster_4)
* [datum-iot](cluster_5)
* [health-mental](cluster_6)
* [uv-air](cluster_7)
* [building-energy](cluster_8)
* [malaria-vector](cluster_9)
* [filter-air](cluster_10)
* [resilience-infrastructure](cluster_11)
* [china-case](cluster_12)
* [respiratory-infection](cluster_13)
* [water-wastewater](cluster_14)
* [detection-object](cluster_15)


# Terms

[5 g](keyword_5_g), [access](keyword_access), [aerosol](keyword_aerosol), [air](keyword_air), [airborne](keyword_airborne), [algorithm](keyword_algorithm), [analysis](keyword_analysis), [analytic](keyword_analytic), [anxiety](keyword_anxiety), [apartment](keyword_apartment), [application](keyword_application), [architecture](keyword_architecture), [area](keyword_area), [artificial intelligence](keyword_artificial_intelligence), [asset](keyword_asset), [attitude](keyword_attitude), [australia](keyword_australia), [bank](keyword_bank), [base](keyword_base), [beijing](keyword_beijing), [biomedical](keyword_biomedical), [blockchain](keyword_blockchain), [blueprint](keyword_blueprint), [box](keyword_box), [breeam](keyword_breeam), [build](keyword_build), [build environment](keyword_build_environment), [building](keyword_building), [business](keyword_business), [camera](keyword_camera), [capacity](keyword_capacity), [case](keyword_case), [catch](keyword_catch), [cause](keyword_cause), [change](keyword_change), [china](keyword_china), [cid](keyword_cid), [city](keyword_city), [climate](keyword_climate), [climate change](keyword_climate_change), [comfort](keyword_comfort), [community](keyword_community), [company](keyword_company), [computer](keyword_computer), [construction](keyword_construction), [control](keyword_control), [coronavirus](keyword_coronavirus), [country](keyword_country), [covid 19 pandemic](keyword_covid_19_pandemic), [covid-19](keyword_covid-19), [crisis](keyword_crisis), [critical](keyword_critical), [dataset](keyword_dataset), [datum](keyword_datum), [deep](keyword_deep), [dengue](keyword_dengue), [density](keyword_density), [depression](keyword_depression), [depressive](keyword_depressive), [design](keyword_design), [detection](keyword_detection), [detector](keyword_detector), [device](keyword_device), [digital](keyword_digital), [digitalisation](keyword_digitalisation), [disease](keyword_disease), [disinfection](keyword_disinfection), [distance](keyword_distance), [domain](keyword_domain), [download](keyword_download), [drone](keyword_drone), [droplet](keyword_droplet), [drug](keyword_drug), [economic](keyword_economic), [economy](keyword_economy), [efficiency](keyword_efficiency), [elimination](keyword_elimination), [employee](keyword_employee), [enclose](keyword_enclose), [energy](keyword_energy), [engineering](keyword_engineering), [environment](keyword_environment), [epidemic](keyword_epidemic), [europe](keyword_europe), [fear](keyword_fear), [filter](keyword_filter), [garrido](keyword_garrido), [gate](keyword_gate), [gbn](keyword_gbn), [germany](keyword_germany), [germicidal](keyword_germicidal), [government](keyword_government), [greece](keyword_greece), [green](keyword_green), [guest](keyword_guest), [health](keyword_health), [healthcare](keyword_healthcare), [high](keyword_high), [home](keyword_home), [hospital](keyword_hospital), [house](keyword_house), [housing](keyword_housing), [humidity](keyword_humidity), [hvac](keyword_hvac), [ieq](keyword_ieq), [image](keyword_image), [impact](keyword_impact), [inactivate](keyword_inactivate), [inactivation](keyword_inactivation), [india](keyword_india), [indoor](keyword_indoor), [industry](keyword_industry), [infection](keyword_infection), [infectious disease](keyword_infectious_disease), [influenza](keyword_influenza), [information](keyword_information), [infrastructure](keyword_infrastructure), [integration](keyword_integration), [internet](keyword_internet), [interoperability](keyword_interoperability), [iot](keyword_iot), [irradiation](keyword_irradiation), [italy](keyword_italy), [january](keyword_january), [knowledge](keyword_knowledge), [light](keyword_light), [live](keyword_live), [lockdown](keyword_lockdown), [london](keyword_london), [maintenance](keyword_maintenance), [malar](keyword_malar), [malaria](keyword_malaria), [management](keyword_management), [manhattan](keyword_manhattan), [mask](keyword_mask), [measure](keyword_measure), [medical](keyword_medical), [medium](keyword_medium), [mental](keyword_mental), [mhv](keyword_mhv), [microorganism](keyword_microorganism), [mobility](keyword_mobility), [model](keyword_model), [mosquito](keyword_mosquito), [need](keyword_need), [network](keyword_network), [new](keyword_new), [new south wale](keyword_new_south_wale), [new york](keyword_new_york), [new york city](keyword_new_york_city), [news](keyword_news), [nile](keyword_nile), [novelcoronavirus](keyword_novelcoronavirus), [object](keyword_object), [occupant](keyword_occupant), [oecd](keyword_oecd), [ontological](keyword_ontological), [ontology](keyword_ontology), [outbreak](keyword_outbreak), [pandemic](keyword_pandemic), [participant](keyword_participant), [particle](keyword_particle), [pathogen](keyword_pathogen), [patient](keyword_patient), [pedestrian](keyword_pedestrian), [people](keyword_people), [perceive](keyword_perceive), [permanent](keyword_permanent), [place](keyword_place), [plan](keyword_plan), [poland](keyword_poland), [policy](keyword_policy), [population](keyword_population), [precision](keyword_precision), [prevention](keyword_prevention), [proceeding](keyword_proceeding), [process](keyword_process), [project](keyword_project), [province](keyword_province), [psychological](keyword_psychological), [public](keyword_public), [public health](keyword_public_health), [quality](keyword_quality), [regular](keyword_regular), [remove](keyword_remove), [representation](keyword_representation), [research](keyword_research), [residential](keyword_residential), [resilience](keyword_resilience), [resilient](keyword_resilient), [respiratory](keyword_respiratory), [risk](keyword_risk), [room](keyword_room), [russia](keyword_russia), [sample](keyword_sample), [sar cov 2](keyword_sar_cov_2), [sector](keyword_sector), [semantic](keyword_semantic), [semenza](keyword_semenza), [sensor](keyword_sensor), [service](keyword_service), [sewage](keyword_sewage), [sewer](keyword_sewer), [shock](keyword_shock), [smart](keyword_smart), [smart city](keyword_smart_city), [social](keyword_social), [solution](keyword_solution), [space](keyword_space), [spain](keyword_spain), [spread](keyword_spread), [study](keyword_study), [supply chain](keyword_supply_chain), [support](keyword_support), [surface](keyword_surface), [survey](keyword_survey), [sustainability](keyword_sustainability), [switzerland](keyword_switzerland), [symptom](keyword_symptom), [system](keyword_system), [tb](keyword_tb), [technology](keyword_technology), [temperature](keyword_temperature), [tool](keyword_tool), [tourism](keyword_tourism), [tourist](keyword_tourist), [transmission](keyword_transmission), [transport](keyword_transport), [travel](keyword_travel), [treatment](keyword_treatment), [tuberculosis](keyword_tuberculosis), [ultraviolet](keyword_ultraviolet), [unesco](keyword_unesco), [united kingdom](keyword_united_kingdom), [united nations](keyword_united_nations), [united states](keyword_united_states), [upper](keyword_upper), [urban](keyword_urban), [usa](keyword_usa), [utility](keyword_utility), [uv](keyword_uv), [uvgi](keyword_uvgi), [vaccine](keyword_vaccine), [vbd](keyword_vbd), [vector](keyword_vector), [ventilation](keyword_ventilation), [video](keyword_video), [violation](keyword_violation), [virus](keyword_virus), [vision](keyword_vision), [ward](keyword_ward), [washington](keyword_washington), [washington dc](keyword_washington_dc), [wastewater](keyword_wastewater), [water](keyword_water), [wear](keyword_wear), [well be](keyword_well_be), [work](keyword_work), [world bank](keyword_world_bank), [world health organization](keyword_world_health_organization), [world heritage site](keyword_world_heritage_site), [wuhan](keyword_wuhan)
