...
* Topics
  * We have identified 15 topics of interest.
  * We have identified 341996 relationships between terms.
* Terms
  * and 459 main terms from the clusters.
  * and 46 other relevant words or expressions.
* Blueprints
  * We are trying 24 blueprints
  * ... which follow our [_mapping_](mapping).

# Blueprints

1. [Rotational Shift System](bp_0)
2. [Smart Locker System](bp_1)
3. [Installing UV in ductwork](bp_10)
4. [Installing high-efficiency air filters](bp_11)
5. [Resilience in staffing and skills training](bp_12)
6. [Negative pressure rooms](bp_13)
7. [Building Adaptation during a pandemic](bp_14)
8. [Air Cleaning Plants](bp_15)
9. [Good hand hygiene practice](bp_16)
10. [Reducing contact points](bp_17)
11. [Mental health – Act: Do something](bp_18)
12. [Mental health – Belong: Do something with someone](bp_19)
13. [Architecture design](bp_2)
14. [Mental health – Commit: Do something meaningfull](bp_20)
15. [Monitoring of wastewater](bp_21)
16. [Animal vectors control](bp_22)
17. [Tracking and enforcing use of Personal Protective Equipment](bp_23)
18. [Indoor Environmental Quality (IEQ) monitoring system](bp_3)
19. [One-way mobility circulation](bp_4)
20. [Antimicrobial Surfaces](bp_5)
21. [Checkpoint allocation for access limitation](bp_6)
22. [Access limitation](bp_7)
23. [Public places as information points](bp_8)
24. [Tender support at building stage](bp_9)
...
* [space-cid](cluster_9)
* [processing-wireless](cluster_10)
* [obesity-county](cluster_11)
* [surveying-drone](cluster_12)
...
[5 g](keyword_5_g), [aalborg](keyword_aalborg), [ac](keyword_ac), [access](keyword_access), [active](keyword_active), [activity](keyword_activity), [ad](keyword_ad), [adapt](keyword_adapt), [adaptation](keyword_adaptation), [aerosol](keyword_aerosol), [agc](keyword_agc), [agent](keyword_agent), [agree](keyword_agree), [air](keyword_air), [airborne](keyword_airborne), [alert](keyword_alert), [algorithm](keyword_algorithm), [analysis](keyword_analysis), [analyst](keyword_analyst), [analytic](keyword_analytic), [antibiotic](keyword_antibiotic), [anxiety](keyword_anxiety), [apartment](keyword_apartment), [application](keyword_application), [architect](keyword_architect), [architectural](keyword_architectural), [architecture](keyword_architecture), [area](keyword_area), [arlington](keyword_arlington), [artificial intelligence](keyword_artificial_intelligence), [ashrae](keyword_ashrae), [assay](keyword_assay), [association](keyword_association), [australia](keyword_australia), [auto](keyword_auto), [bank](keyword_bank), [bare](keyword_bare), [base](keyword_base), [beginning](keyword_beginning), [behavioural](keyword_behavioural), [beijing](keyword_beijing), [big](keyword_big), [bim](keyword_bim), [biomarker](keyword_biomarker), [biomass](keyword_biomass), [biometric](keyword_biometric), [biophilic](keyword_biophilic), [biosensor](keyword_biosensor), [bl](keyword_bl), [blockchain](keyword_blockchain), [blueprint](keyword_blueprint), [bracelet](keyword_bracelet), [brand](keyword_brand), [build](keyword_build), [build environment](keyword_build_environment), [building](keyword_building), [buildings](keyword_buildings), [business](keyword_business), [camera](keyword_camera), [canopy](keyword_canopy), [capture](keyword_capture), [care](keyword_care), [case](keyword_case), [cctv](keyword_cctv), [centrality](keyword_centrality), [change](keyword_change), [chatbot](keyword_chatbot), [china](keyword_china), [chronic](keyword_chronic), [cid](keyword_cid), [city](keyword_city), [click](keyword_click), [climate](keyword_climate), [climate change](keyword_climate_change), [clinical](keyword_clinical), [cloud](keyword_cloud), [club](keyword_club), [coat](keyword_coat), [community](keyword_community), [company](keyword_company), [computer](keyword_computer), [concentration](keyword_concentration), [conditioning](keyword_conditioning), [conference](keyword_conference), [construction](keyword_construction), [consumer](keyword_consumer), [contact](keyword_contact), [contactless](keyword_contactless), [contain](keyword_contain), [contamination](keyword_contamination), [contractor](keyword_contractor), [control](keyword_control), [cook](keyword_cook), [coron](keyword_coron), [corona](keyword_corona), [coronavirus](keyword_coronavirus), [corporate](keyword_corporate), [correlate](keyword_correlate), [corridor](keyword_corridor), [cost](keyword_cost), [country](keyword_country), [county](keyword_county), [courtyard](keyword_courtyard), [covid 19 pandemic](keyword_covid_19_pandemic), [covid-19](keyword_covid-19), [cr](keyword_cr), [crisis](keyword_crisis), [crowd](keyword_crowd), [customer](keyword_customer), [datum](keyword_datum), [daylight](keyword_daylight), [decentralize](keyword_decentralize), [delivery](keyword_delivery), [demographic](keyword_demographic), [density](keyword_density), [design](keyword_design), [detect](keyword_detect), [detection](keyword_detection), [deviation](keyword_deviation), [device](keyword_device), [diagnosis](keyword_diagnosis), [digital](keyword_digital), [disease](keyword_disease), [disinfect](keyword_disinfect), [disinfection](keyword_disinfection), [dog](keyword_dog), [door](keyword_door), [dow](keyword_dow), [drone](keyword_drone), [drones](keyword_drones), [droplet](keyword_droplet), [drug](keyword_drug), [due](keyword_due), [dwell](keyword_dwell), [economic](keyword_economic), [economy](keyword_economy), [edition](keyword_edition), [education](keyword_education), [effect](keyword_effect), [efficacy](keyword_efficacy), [emerge](keyword_emerge), [employee](keyword_employee), [employment](keyword_employment), [enable](keyword_enable), [end](keyword_end), [energy](keyword_energy), [enforce](keyword_enforce), [engineer](keyword_engineer), [engineering](keyword_engineering), [entrance](keyword_entrance), [environment](keyword_environment), [environmental](keyword_environmental), [epidemic](keyword_epidemic), [epidemiology](keyword_epidemiology), [europe](keyword_europe), [exist](keyword_exist), [experience](keyword_experience), [expose](keyword_expose), [exposure](keyword_exposure), [fabrication](keyword_fabrication), [face](keyword_face), [facility](keyword_facility), [factor](keyword_factor), [fatality](keyword_fatality), [filter](keyword_filter), [filtration](keyword_filtration), [fin](keyword_fin), [final](keyword_final), [finalize](keyword_finalize), [finally](keyword_finally), [find](keyword_find), [fink](keyword_fink), [fiorillo](keyword_fiorillo), [fiorito](keyword_fiorito), [fire](keyword_fire), [firm](keyword_firm), [firmly](keyword_firmly), [fix](keyword_fix), [flexible](keyword_flexible), [flow](keyword_flow), [frank](keyword_frank), [fuel](keyword_fuel), [gang](keyword_gang), [garden](keyword_garden), [gas](keyword_gas), [gaseous](keyword_gaseous), [gene](keyword_gene), [geo](keyword_geo), [geolocation](keyword_geolocation), [germany](keyword_germany), [germicidal](keyword_germicidal), [god](keyword_god), [government](keyword_government), [grad](keyword_grad), [green](keyword_green), [guest](keyword_guest), [hamidi](keyword_hamidi), [handler](keyword_handler), [health](keyword_health), [healthcare](keyword_healthcare), [help](keyword_help), [hepa](keyword_hepa), [heterogeneity](keyword_heterogeneity), [high](keyword_high), [hj](keyword_hj), [hospital](keyword_hospital), [house](keyword_house), [household](keyword_household), [housing](keyword_housing), [html](keyword_html), [human](keyword_human), [humidity](keyword_humidity), [hvac](keyword_hvac), [iaq](keyword_iaq), [identify](keyword_identify), [ieq](keyword_ieq), [immunity](keyword_immunity), [impact](keyword_impact), [include](keyword_include), [increase](keyword_increase), [index](keyword_index), [india](keyword_india), [indirect](keyword_indirect), [indoor](keyword_indoor), [industrialization](keyword_industrialization), [industry](keyword_industry), [infect](keyword_infect), [infection](keyword_infection), [infectious](keyword_infectious), [infectious disease](keyword_infectious_disease), [influenza](keyword_influenza), [information](keyword_information), [infrastructure](keyword_infrastructure), [innovative](keyword_innovative), [intelligence](keyword_intelligence), [interface](keyword_interface), [internet](keyword_internet), [iot](keyword_iot), [ip](keyword_ip), [ipc](keyword_ipc), [irradiation](keyword_irradiation), [isr](keyword_isr), [italy](keyword_italy), [job](keyword_job), [jones](keyword_jones), [kg](keyword_kg), [labour](keyword_labour), [lang](keyword_lang), [learn](keyword_learn), [lessen](keyword_lessen), [level](keyword_level), [lift](keyword_lift), [liv](keyword_liv), [live](keyword_live), [llc](keyword_llc), [lockdown](keyword_lockdown), [locker](keyword_locker), [london](keyword_london), [low](keyword_low), [machine learning](keyword_machine_learning), [main](keyword_main), [make](keyword_make), [malaria](keyword_malaria), [management](keyword_management), [manhattan](keyword_manhattan), [mapping](keyword_mapping), [marker](keyword_marker), [market](keyword_market), [material](keyword_material), [maximum](keyword_maximum), [measure](keyword_measure), [medical](keyword_medical), [member](keyword_member), [mental](keyword_mental), [method](keyword_method), [minimise](keyword_minimise), [mining](keyword_mining), [mm](keyword_mm), [mobile](keyword_mobile), [model](keyword_model), [module](keyword_module), [monitor](keyword_monitor), [mortality](keyword_mortality), [nassereddine](keyword_nassereddine), [natural](keyword_natural), [ne](keyword_ne), [need](keyword_need), [network](keyword_network), [new](keyword_new), [new south wale](keyword_new_south_wale), [new york](keyword_new_york), [new york city](keyword_new_york_city), [nightingale](keyword_nightingale), [node](keyword_node), [novelcoronavirus](keyword_novelcoronavirus), [number](keyword_number), [obesity](keyword_obesity), [object](keyword_object), [occupancy](keyword_occupancy), [occupant](keyword_occupant), [office](keyword_office), [ontology](keyword_ontology), [organisation](keyword_organisation), [organization](keyword_organization), [outbreak](keyword_outbreak), [pandemic](keyword_pandemic), [parameter](keyword_parameter), [participant](keyword_participant), [particle](keyword_particle), [pathogen](keyword_pathogen), [patient](keyword_patient), [pavilion](keyword_pavilion), [pcr](keyword_pcr), [pedestrian](keyword_pedestrian), [people](keyword_people), [per](keyword_per), [percent](keyword_percent), [permission](keyword_permission), [person](keyword_person), [phase](keyword_phase), [physical](keyword_physical), [pi](keyword_pi), [plan](keyword_plan), [plant](keyword_plant), [platform](keyword_platform), [pmc](keyword_pmc), [poland](keyword_poland), [policy](keyword_policy), [pollutant](keyword_pollutant), [pollution](keyword_pollution), [population](keyword_population), [power](keyword_power), [practice](keyword_practice), [precautionary](keyword_precautionary), [prediction](keyword_prediction), [predictive](keyword_predictive), [present](keyword_present), [pressure](keyword_pressure), [prevalence](keyword_prevalence), [prevention](keyword_prevention), [primer](keyword_primer), [privacy](keyword_privacy), [processing](keyword_processing), [productivity](keyword_productivity), [project](keyword_project), [prototype](keyword_prototype), [provide](keyword_provide), [pt](keyword_pt), [public](keyword_public), [public health](keyword_public_health), [qpcr](keyword_qpcr), [quality](keyword_quality), [quarantine](keyword_quarantine), [random](keyword_random), [raspberry](keyword_raspberry), [rate](keyword_rate), [real](keyword_real), [recognition](keyword_recognition), [reduce](keyword_reduce), [region](keyword_region), [relationship](keyword_relationship), [relevant](keyword_relevant), [remote](keyword_remote), [report](keyword_report), [research](keyword_research), [researcher](keyword_researcher), [resident](keyword_resident), [residential](keyword_residential), [resilience](keyword_resilience), [respiratory](keyword_respiratory), [respondent](keyword_respondent), [response](keyword_response), [result](keyword_result), [retailer](keyword_retailer), [reveal](keyword_reveal), [rh](keyword_rh), [risk](keyword_risk), [rna](keyword_rna), [robot](keyword_robot), [roof](keyword_roof), [room](keyword_room), [rt](keyword_rt), [russia](keyword_russia), [safety](keyword_safety), [saini](keyword_saini), [salli](keyword_salli), [sample](keyword_sample), [sar cov 2](keyword_sar_cov_2), [say](keyword_say), [scmp](keyword_scmp), [se](keyword_se), [sector](keyword_sector), [sensor](keyword_sensor), [server](keyword_server), [service](keyword_service), [sewage](keyword_sewage), [shenzhen](keyword_shenzhen), [show](keyword_show), [silicon](keyword_silicon), [sit](keyword_sit), [site](keyword_site), [skill](keyword_skill), [sm](keyword_sm), [smart](keyword_smart), [smart city](keyword_smart_city), [smartphone](keyword_smartphone), [smartwatch](keyword_smartwatch), [sme](keyword_sme), [smitte](keyword_smitte), [social](keyword_social), [sociale](keyword_sociale), [solution](keyword_solution), [space](keyword_space), [spain](keyword_spain), [sport](keyword_sport), [spread](keyword_spread), [store](keyword_store), [str](keyword_str), [strategy](keyword_strategy), [student](keyword_student), [study](keyword_study), [sunlight](keyword_sunlight), [supply](keyword_supply), [supply chain](keyword_supply_chain), [surface](keyword_surface), [surgical](keyword_surgical), [surveillance](keyword_surveillance), [survey](keyword_survey), [sustainability](keyword_sustainability), [sustainable](keyword_sustainable), [switzerland](keyword_switzerland), [symptom](keyword_symptom), [system](keyword_system), [tailor](keyword_tailor), [take](keyword_take), [task](keyword_task), [tb](keyword_tb), [technology](keyword_technology), [tele](keyword_tele), [telecommute](keyword_telecommute), [telemedicine](keyword_telemedicine), [telework](keyword_telework), [teleworke](keyword_teleworke), [temperature](keyword_temperature), [test](keyword_test), [time](keyword_time), [total](keyword_total), [trace](keyword_trace), [trademark](keyword_trademark), [training](keyword_training), [transmission](keyword_transmission), [transportation](keyword_transportation), [travel](keyword_travel), [treatment](keyword_treatment), [tree](keyword_tree), [tt](keyword_tt), [ture](keyword_ture), [type](keyword_type), [uav](keyword_uav), [ultraviolet](keyword_ultraviolet), [unesco](keyword_unesco), [united kingdom](keyword_united_kingdom), [united nations](keyword_united_nations), [united states](keyword_united_states), [unobserved](keyword_unobserved), [upper](keyword_upper), [urban](keyword_urban), [usa](keyword_usa), [user](keyword_user), [uv](keyword_uv), [uvgi](keyword_uvgi), [vaccination](keyword_vaccination), [vaccine](keyword_vaccine), [variable](keyword_variable), [ventilation](keyword_ventilation), [video](keyword_video), [ville](keyword_ville), [viral](keyword_viral), [virtual](keyword_virtual), [virus](keyword_virus), [visualization](keyword_visualization), [vocs](keyword_vocs), [walkability](keyword_walkability), [walkable](keyword_walkable), [ward](keyword_ward), [washington](keyword_washington), [washington dc](keyword_washington_dc), [wastewater](keyword_wastewater), [water](keyword_water), [waterborne](keyword_waterborne), [way](keyword_way), [wearable](keyword_wearable), [well](keyword_well), [well be](keyword_well_be), [wireless](keyword_wireless), [work](keyword_work), [worker](keyword_worker), [workforce](keyword_workforce), [workplace](keyword_workplace), [world bank](keyword_world_bank), [world health organization](keyword_world_health_organization), [world heritage site](keyword_world_heritage_site), [wuhan](keyword_wuhan), [wwtp](keyword_wwtp), [zigbee](keyword_zigbee)
