 ...
 * [academy](keyword_academy), [aerosol](keyword_aerosol), antibacterial, [antimicrobial](keyword_antimicrobial), [antiviral](keyword_antiviral), au, [australia](keyword_australia), [bacteria](keyword_bacteria), bio mater, carbon, cell membrane, [coat](keyword_coat), [coating](keyword_coating), commune, composite, [copper](keyword_copper), [coronavirus](keyword_coronavirus), [covid-19](keyword_covid-19), cu, curcumin, current pandemic, cytotoxicity, das, [disinfect](keyword_disinfect), [disinfectant](keyword_disinfectant), [disinfection](keyword_disinfection), [droplet](keyword_droplet), [drug](keyword_drug), e v, electrostatic interaction, elevator button, envelope, face mask, fig al, fullerene, gbns, ghaderi, go, goel, [graphene](keyword_graphene), graphene oxide, graphite, graphite oxide, [health](keyword_health), inactivation, [infection](keyword_infection), [infectious disease](keyword_infectious_disease), [influenza](keyword_influenza), [interface](keyword_interface), [manhattan](keyword_manhattan), [mater](keyword_mater), mater mater, microbe, [microorganism](keyword_microorganism), mnps, mol, nanocomposite, nanomaterial, nanoparticle, nanosheet, nanosystem, nanotech, nanotechnol, nanotechnology, [new south wale](keyword_new_south_wale), [new york city](keyword_new_york_city), nucleic acid, organic, oxygen, paint, [pandemic](keyword_pandemic), [pathogen](keyword_pathogen), plastic, [polymer](keyword_polymer), protein, [public](keyword_public), rgo, [rna](keyword_rna), s p, s protein, sanitization, [sar cov 2](keyword_sar_cov_2), sarada, silver nanoparticle, skin, [spread](keyword_spread), [stainless steel](keyword_stainless_steel), [surface](keyword_surface), surface and interface, surface charge, surface coating, [symptom](keyword_symptom), toxicity, [vaccine](keyword_vaccine), varnish, victoria, [viral](keyword_viral), [virus](keyword_virus), who, who int


## Concepts

 ![](plotly/article_ayub_graphene-based_2021.svg)
