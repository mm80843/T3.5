 ...
 * a davis, aashto, adversity, baldwin, [business](keyword_business), catalyst, centre for economic policy research, [china](keyword_china), civil engineering, [construction](keyword_construction), [construction industry](keyword_construction_industry), construction project, construction sector, construction system, [construction worker](keyword_construction_worker), [coronavirus](keyword_coronavirus), [country](keyword_country), covid 19 outbreak, [covid 19 pandemic](keyword_covid_19_pandemic), [covid-19](keyword_covid-19), cp, database, di mauro, disease pandemic, dot, earthquake, ebola, economic outlook, economist, [economy](keyword_economy), employment, [engineering](keyword_engineering), [environment](keyword_environment), environmental, [epidemic](keyword_epidemic), equipment, [face mask](keyword_face_mask), first covid 19 case, flu, gold price chart, [government](keyword_government), hazard zone, [health](keyword_health), [health and safety](keyword_health_and_safety), household waste, human factor society, [impact](keyword_impact), [india](keyword_india), [industry](keyword_industry), [inequality](keyword_inequality), [infectious disease](keyword_infectious_disease), [infrastructure](keyword_infrastructure), insider, interview, [logistic](keyword_logistic), [london](keyword_london), [maintenance](keyword_maintenance), manage, medical technological development, mediterranean basin, middle east, mitigate, najafi, natural disaster, [new york](keyword_new_york), [oecd](keyword_oecd), [operation](keyword_operation), ozone, [pandemic](keyword_pandemic), patel b, personal relationship, pollution, prevention, [public health](keyword_public_health), [public transport](keyword_public_transport), public transportation, readiness, rec, [resilience](keyword_resilience), resilient, [risk](keyword_risk), safe zone, [safety](keyword_safety), sida, [social distancing](keyword_social_distancing), [society](keyword_society), [state](keyword_state), stay at home, survey, [sustainable](keyword_sustainable), sverigesradio, toll, transit agency, transportation, [virus](keyword_virus), voxeu, voxeu org, [washington dc](keyword_washington_dc), work fromhome, [worker](keyword_worker)


## Concepts

 ![](imgs/article_kaushal_strategies_2021.jpg)
