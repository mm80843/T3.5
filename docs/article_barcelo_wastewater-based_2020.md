 ...
 * anhui, antibodie, antibody, antigen, asymptomatic, [australia](keyword_australia), bibby, biochem, biochemical, bioelectron, biological sample, [biomarker](keyword_biomarker), biomerieux, biomolecule, [biosensor](keyword_biosensor), biotechnol, chemical, [china](keyword_china), concentration method, covid 19 outbreak, [covid 19 pandemic](keyword_covid_19_pandemic), [covid-19](keyword_covid-19), crispr, daughton, [detection](keyword_detection), device, diagnostic, diagnostic method, diarrhea, disadvantage, [disease](keyword_disease), dpcr, ecuador, efﬂuent, electron, elisa, environmental engineering, [epidemic](keyword_epidemic), epidemiologist, [epidemiology](keyword_epidemiology), fece, fet, fet biosensor, [france](keyword_france), gastrointestinal symptom, [gene](keyword_gene), genetic information, [germany](keyword_germany), global pandemic, [health](keyword_health), hefei, immunoglobulin, [india](keyword_india), [infect](keyword_infect), inﬂammatory response biomarker, inﬂuent, inﬂuenza, isoprostane, [japan](keyword_japan), lab on a chip, lionx, loc, loc poc, louisiana, [manhattan](keyword_manhattan), [mer cov](keyword_mer_cov), microﬂuidic, ms, [new york city](keyword_new_york_city), nucleic acid, nucleic acid base polymerase chain reaction, nucleic acid extraction, [pandemic](keyword_pandemic), paris, [pcr](keyword_pcr), pcr assay, [primer](keyword_primer), protein, proteomic, quantiﬁcation, quito, rna extraction, rt qpcr, [sar cov 2](keyword_sar_cov_2), [sensor](keyword_sensor), [sewage](keyword_sewage), smartphone, [spain](keyword_spain), st petersburg, surface plasmon resonance, [technology](keyword_technology), [transmission](keyword_transmission), urine, usa, [virus](keyword_virus), virus detection, [wastewater](keyword_wastewater), wastewater base epidemiology, wastewater matrix, ﬂuid


## Concepts

 ![](imgs/article_barcelo_wastewater-based_2020.jpg)
