 ...
 * [academy](keyword_academy), [antibiotic](keyword_antibiotic), antibiotic resistance, [antimicrobial](keyword_antimicrobial), antimicrobial resistance, [antiviral](keyword_antiviral), [australia](keyword_australia), biological, [biomarker](keyword_biomarker), biomonitoring, [canada](keyword_canada), carcinogen, castiglioni, chemical, chemical compound, [china](keyword_china), chromatic, chromatogr, compound, [coronavirus](keyword_coronavirus), [covid-19](keyword_covid-19), cryptosporidium, [disease](keyword_disease), disease outbreak, drug, drug abuse, drug test, [economic](keyword_economic), effluent, emerg, emerg emerg, emerge infectious disease, environmental exposure, [epidemic](keyword_epidemic), [epidemiological](keyword_epidemiological), epidemiologist, [epidemiology](keyword_epidemiology), ethic, [exposure](keyword_exposure), [gene](keyword_gene), [genome](keyword_genome), genre, [globalisation](keyword_globalisation), hazard, healing, [health](keyword_health), health perspect, illicit drug, infect bmc, [infection](keyword_infection), [infectious disease](keyword_infectious_disease), infectious disease surveillance, interleukin, [japan](keyword_japan), kasprzyk hordern, mass spectrometry, medicine, metabolite, [microbiol](keyword_microbiol), [monitor](keyword_monitor), [outbreak](keyword_outbreak), [pathogen](keyword_pathogen), pathogenic, pharmaceutical, polio, [population](keyword_population), population size, prescription, protein, [public health](keyword_public_health), public health surveillance, rep, resistance, resistance gene, respiratory infection, science, science fiction, [sewage](keyword_sewage), [social](keyword_social), spatial, [spread](keyword_spread), surface water, [surveillance](keyword_surveillance), [symptom](keyword_symptom), tamiflu, tandem mass spectrometry, technol sci, test, tobacco, trend, [tuberculosis](keyword_tuberculosis), urine, [viral](keyword_viral), [virus](keyword_virus), [wastewater](keyword_wastewater), wastewater analysis, wastewater base epidemiology, wastewater treatment, wastewater treatment plant, water fingerprinting


## Concepts

 ![](imgs/article_sims_future_2020.jpg)
